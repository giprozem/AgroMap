...
from ai.utils.predicting_culture import predicting_culture, predict_culture
    ...
    def get(self, request):
        ...
        if culture:
            with connection.cursor() as cursor:
                cursor.execute(
                    f"""
                SELECT aic.district_id, aic.culture_id, MAX(aic.elevation) as max_elevation, MIN(aic.elevation) as min_elevation,
                ...
                GROUP BY aic.district_id, aic.culture_id;
                """)
        ...
        for i in rows:
            data.append(
                {'district_id': i[0], 'culture_id': i[1], 'max_elevation': i[2], 'min_elevation': i[3],
                 ...
                 'ndre_max': i[10],
                 'ndre_min': i[11], 'savi_max': i[12], 'savi_min': i[13], 'year': '2022'}
            )
