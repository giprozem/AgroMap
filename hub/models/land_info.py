...
class LandInfo(BaseModel):
    ...
    crmid = models.CharField(max_length=55, blank=True, null=True, verbose_name=_('Идентификационный номер'))
    ...
    setype = models.CharField(max_length=55, blank=True, null=True, verbose_name=_('Тип'))
