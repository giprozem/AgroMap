...
class ContourAdmin(LeafletGeoAdmin, SimpleHistoryAdmin):
    change_list_template = "admin/shape_file_buttons.html"
    readonly_fields = (
        "id",
        "created_at",
        "updated_at",
    ...
    display_district_name.short_description = _("District")
